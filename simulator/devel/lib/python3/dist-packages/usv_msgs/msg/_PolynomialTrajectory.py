...
"""autogenerated by genpy from usv_msgs/PolynomialTrajectory.msg. Do not edit."""
import codecs
import sys
...
class PolynomialTrajectory(genpy.Message):
  _md5sum = "df4ecebd1c68590fe40691d3e33566ab"
  _type = "usv_msgs/PolynomialTrajectory"
...
"""
  ...
  __slots__ = ['header','trajectory_id','action','num_order','num_segment','start_yaw','final_yaw','coef_x','coef_y','time','mag_coeff','order','debug_info']
  _slot_types = ['std_msgs/Header','uint32','uint32','uint32','uint32','float64','float64','float64[]','float64[]','float64[]','float64','uint32[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,trajectory_id,action,num_order,num_segment,start_yaw,final_yaw,coef_x,coef_y,time,mag_coeff,order,debug_info
