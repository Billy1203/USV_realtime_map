...
(cl:defmethod cl:initialize-instance :after ((m <GlbObsRcv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlbObsRcv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usv_msgs-srv:<GlbObsRcv-request> is deprecated: use usv_msgs-srv:GlbObsRcv-request instead.")))

(cl:ensure-generic-function 'req-val :lambda-list '(m))
(cl:defmethod req-val ((m <GlbObsRcv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_msgs-srv:req-val is deprecated.  Use usv_msgs-srv:req instead.")
  (req m))
...
(cl:defmethod cl:initialize-instance :after ((m <GlbObsRcv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlbObsRcv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usv_msgs-srv:<GlbObsRcv-response> is deprecated: use usv_msgs-srv:GlbObsRcv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <GlbObsRcv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_msgs-srv:result-val is deprecated.  Use usv_msgs-srv:result instead.")
  (result m))
